    ...
    return (
        <>
            <Head>
                ...
                <meta name="og:url" content={`https://Spritearc.com/profile?user=${public_user.username}`}/>
				<meta name="og:type" content="website" />
				<meta name="og:title" content={`${public_user.username}`}/>
				<meta name="og:description" content={`${public_user.description}`}/>
				<meta name="og:image" content={`${process.env.NEXT_PUBLIC_SPRITEARC_API}/profile_pictures/${public_user.profile_picture}`}/>
				<meta name="og:image:secure_url" content={`${process.env.NEXT_PUBLIC_SPRITEARC_API}/profile_pictures/${public_user.profile_picture}`}/>

				<meta name="twitter:card" content="summary"/>
				<meta name="twitter:domain" content="Spritearc.com"/>
				<meta name="twitter:url" content={`https://Spritearc.com/profile?user${public_user.username}`}/>
