				...
				<div className="content">
					...
					<div className="header_container">
						...
						<div className="background">
							<Image loading='eager' unoptimized={true} quality="100%" src={Eclipse} layout="fill" alt="A pixelart image that displays a universe" className="background_image" id="news_background_image"/>
