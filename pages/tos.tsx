    ...
    return(
        <section>
            ...
            <ul>
                ...
                <li>
                    <b>Company:</b> when this policy mentions Company "we" us," or "our" it refers to Spritearc that is responsible for your
                    information under this Privacy Policy.
                </li>

                <li>
                    <b>Country:</b>  where Spritearc or the owners/founders of Spritearc are based in this case is Germany.
                </li>
                
                <li>
                    <b>Customer:</b> refers to the company, organization or person that signs up to use the Spritearc Service to manage the relationships with your consumers or service users.
                </li>

                <li>
                    <b>Device:</b> any internet connected device such as a phone, tablet, computer or any other device that can be used to visit Spritearc.
                </li>
                ...
                <li>
                    <b>Personnel:</b> refers to those individuals who are employed by Spritearc or are under contract to perform a service on behalf one of the parties.
                </li>
                ...
                <li>
                    <b>Service:</b> refers to the service provided by Spritearc as described in the relative terms of available) and on this platform.
                </li>
                ...
                <li>
                    <b>Website:</b>  Spritearc's site, which can be accessed via this URL, Spritearc.com
                </li>

                <li>
                    <b>You:</b>  a person or entity that is registered with Spritearc to use the Services.
                </li>
            </ul>
        </section>
    )
    ...
    return(
        <section>
            ...
            <p>You agree not to, and you will not permit others to:
                ...
                Modify, make derivative works of disassemble, decrypt, reverse compile or reverse engineer any part of the service Remove, alter or obscure any proprietary notice (including any notice of copyright or trademark) of or its affiliates, partners, suppliers or the licensors of the service.
            </p>
        </section>
    )
}
    ...
    return(
        <section>
            ...
            <p>Thanks for shopping with us. We appreciate the fact that you like to buy the stuff we build We also want to make sure you have a rewarding experience while you're exploring, evaluating, and purchasing our products
                ...
                As with any shopping experience, there are terms and conditions that apply to transactions at our company We'll be as brief as our attomeys will allow. The main thing to remember is that by placing an order or making a purchase from us, you agree to the terms along with our Privacy Policy.
...
function Modifications_to_our_service() {
    return(
        <section>
            ...
            <p>We reserve the right to modify, suspend or discontinue, temporarily or permanently, the service or any service to which it connects, with or without notice and without liability to you.
            </p>
        </section>
    )
}
...
function Indemnification() {
    return(
        <section>
            ...
            <p>You agree to indemnity and hold us and our parents, subsidiaries, affiliates, officers, employees, agents, partners and licensors (if any) harmless from any claim or demand, including reasonable attorneys' fees, due to or arising out of your (a) use of the service; (b) violation of this Agreement or any law or regulation, or (c) violation of any right of a third party.
            </p>
        </section>
    )
}
...
function Waiver() {
    return(
        <section>
            <h1>{`Waiver`}</h1>
            <p>Except as provided herein, the failure to exercise a night or to require performance of an obligation under this Agreement shall not effect a party's ability to exercise such right or require such performance at any time thereafter nor shall be the waiver of a breach constitute waiver of any subsequent breach
