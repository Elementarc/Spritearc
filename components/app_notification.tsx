    ...
    useEffect(() => {
        ...
        const observer = new ResizeObserver(() => {
            ...
            if(app_fixed_container && app_content_container) {
                ...
                app_fixed_container.style.height = `${window.innerHeight}px`
            ...
            <AnimatePresence exitBeforeEnter>
                {toggle &&
                    ...
                    <motion.div initial={{opacity: 0}} animate={{opacity: 1, transition: {duration: .2}}} exit={{opacity: 0, transition: {duration: .2}}} className="app_overlay_fixed" id="app_overlay_fixed">
                        ...
                        <motion.div key="notification_container" initial={{scale: .8}} animate={{scale: 1}} exit={{scale: .8}} className="notification_container">
